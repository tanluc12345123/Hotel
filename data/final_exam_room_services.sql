...
CREATE TABLE `room_services` (
  ...
  KEY `FKrvoqlh9yqrup1v41ejfevv6po` (`service_id`),
  CONSTRAINT `FKewq1euu8r5i0c2f1ejfout7ty` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`),
  CONSTRAINT `FKrvoqlh9yqrup1v41ejfevv6po` FOREIGN KEY (`service_id`) REFERENCES `services` (`id`)
...
-- Dump completed on 2022-01-16 23:14:13
